...
const { createProject, updateProject, deleteProject, getAllProjectsByCategoryID, projectDetails, getAllProjects, updateProjectByCloudinary, ProjectFolderNamesByCloudinary } = require("../controllers/project.controller")
